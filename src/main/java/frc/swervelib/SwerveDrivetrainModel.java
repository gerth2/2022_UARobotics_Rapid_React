...
public class SwerveDrivetrainModel {
    ...
    public void update(boolean isDisabled, double batteryVoltage){
        ...
        SmartDashboard.putNumber("FLSteerAngleMeas_rev", realModules.get(0).getSteerAngle() / 2.0 / Math.PI);
        SmartDashboard.putNumber("FRSteerAngleMeas_rev", realModules.get(1).getSteerAngle() / 2.0 / Math.PI);
        SmartDashboard.putNumber("BLSteerAngleMeas_rev", realModules.get(2).getSteerAngle() / 2.0 / Math.PI);
        SmartDashboard.putNumber("BRSteerAngleMeas_rev", realModules.get(3).getSteerAngle() / 2.0 / Math.PI);
    }
