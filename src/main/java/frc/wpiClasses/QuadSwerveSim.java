...
public class QuadSwerveSim {
    ...
    QuadSwerveSimVisualization m_viz;

    FieldObject2d m_simRobotPose;
    ...
    public QuadSwerveSim(
        ...
        m_viz = new QuadSwerveSimVisualization(wheelBaseWidthM, wheelBaseLengthM, modules);

        SmartDashboard.putData("SimSwerveModule_FL", modules.get(FL));
        SmartDashboard.putData("SimSwerveModule_FR", modules.get(FR));
        SmartDashboard.putData("SimSwerveModule_BL", modules.get(BL));
        SmartDashboard.putData("SimSwerveModule_BR", modules.get(BR));
