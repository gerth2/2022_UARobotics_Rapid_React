...
public class SwerveModuleSim implements Sendable{
    ...
    private double getWheelMotorVoltage(){
        return this.m_wheelVoltage;
    }

    private double getAzmthMotorVoltage(){
        return this.m_azmthVoltage;
    }
